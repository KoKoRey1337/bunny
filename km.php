...
<button onclick="window.location.href='https://www.bssn.go.id/'">Touch Me >.<</button>

<script>
    // No longer needed JavaScript logic for this example
</script>
